            ...
            <div className='is-flex is-between is-align-center site-header_wrap'>
                ...
                <nav>
                    <ul className='is-flex is-center is-align-center fw-500 is-uppercase'>
                        {MenuData.map((item) =>{
                          return(
                            <li key={item.id} onClick = {() => toggleClass(item.name)} className={active === item.name ? "is-acitve" : ""} >
                ...
                <div className='is-flex is-end is-align-center col-gap-12'>
                    <Link to='./signin' className='btn btn-primary  is-flex is-align-center col-gap-8 fw-500'>
                      <FiMessageSquare/>
